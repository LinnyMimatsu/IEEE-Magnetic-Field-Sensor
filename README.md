The IEEE-Magnetic-Field-Sensor.asc file must be ran in LT Spice to be able to change around the schematics
...
- **DO NOT** plug the servo motor in to the 5V or 3.3V pin on the Arduino.
